...
<script src="/resumeprocessing/resources/js/routes/interviewerRoutes.js"></script>
</head>
<body ng-app="interviewerApp">
	<div class="large-12 columns">
		<center>
			<h3>Employee Interview App</h3>
		</center>
	</div>
	<div class="large-12 columns" ng-controller="utilController as ctrl"
		...
		<div class="medium-3 columns">
			<ul class="tabs vertical" id="example-vert-tabs" data-tabs>
				<li class="tabs-title is-active"><a ui-sref="new">New
						Interviewer Details</a></li>
				<li class="tabs-title"><a ui-sref="search">Search
						Interviewers</a></li>
				<!--  <li class="tabs-title is-active"><a href="#/newInterviewer" aria-selected="true">New Interviewer Details</a></li>
      <li class="tabs-title"><a href="#/searchInterviewer">Search Interviewers</a></li>
		...
		<div class="medium-9 columns">
			<div class="tabs-content vertical"
				...
				<div class="tabs-panel" id="panel2v">
					<div class="row">
						<div class="callout panel">
							<button class="button" ng-click="dispAllInterviewers()">Retrieve
								All Interviewers</button>
							...
							<div class="callout panel" ng-show="showsearchdiv">
								...
								<table width="60%">
									<tr>
										...
										<td><select ng-model="searchCriteria"
											ng-change="CheckforSkills()">
									...
									<div class="callout panel">
										<fieldset>
											<div class="small-3 columns">
												<h5>Languages</h5>
												<pre ng-repeat="language in techSkills.Languages">
													<input type="checkbox" ng-model="names.Selected"
														ng-click="toggleSelection(language)" />{{language}}</pre>
											</div>

											<div class="small-3 columns">
												<h5>Source control Tools</h5>
												<pre ng-repeat="tool in techSkills.SouceControlTools">
													<input type="checkbox" ng-model="names.Selected"
														ng-click="toggleSelection(tool)" />{{tool}}</pre>
											</div>

											<div class="small-3 columns">
												<h5>Web Technologies</h5>
												<pre ng-repeat="technology in techSkills.WebTechnologies">
													<input type="checkbox" ng-model="names.Selected"
														ng-click="toggleSelection(technology)" />{{technology}}</pre>
											</div>
											<div class="small-3 columns">
												<h5>Operating Systems</h5>
												<pre ng-repeat="os in techSkills.OperatingSystems">
													<input type="checkbox" ng-model="names.Selected"
														ng-click="toggleSelection(os)" />{{os}}</pre>
											</div>
										</fieldset>
									</div>
								</fieldset>
							...
							<div ng-show="ViewSelected" class="callout panel">
								<fieldset>
									...
									<table width="100%">
										<tr>
											<td>First Name</td>
											<td>{{selInterviewer.firstname}}</td>
										</tr>
										<tr>
											<td>Last Name</td>
											<td>{{selInterviewer.lastname}}</td>
										</tr>
										<tr>
											<td>email address</td>
											<td>{{selInterviewer.mail}}</td>
										</tr>
										<tr>
											<td>Current Experience</td>
											<td>{{selInterviewer.contact}}</td>
										</tr>
										<tr>
											<td>Total Experience</td>
											<td>{{selInterviewer.totalexperience}}</td>
										</tr>
										<tr>
											<td>Quicklook id</td>
											<td>{{selInterviewer.quicklookid}}</td>
										</tr>
									</table>
								</fieldset>
								...
								<fieldset>
									...
									<div class="callout panel">
										<pre>Skill set :{{selInterviewer.expertese}}</pre>

									</div>
								</fieldset>

								<div>
									<button class="button" ng-click="restoreViewAll()">Back</button>
									<button class="button"
										ng-click="editEmployee(selemp.emp.contact)">Edit</button>
								</div>
