(function(){
var applicantObj = angular.module("applicantApp",[]);
var projectcount = 0;

applicantObj.controller("mainController",function($http,$scope,EmpshowService,$location,$sce){
...
applicantObj.controller("displayController" ,function($http,$scope,EmpshowService){
...
applicantObj.factory('EmpshowService', function() {
...
applicantObj.directive("addprojectsdiv", function(){
	return {
		restrict: "E",
...
applicantObj.directive("adddivs", function($compile){
...
applicantObj.directive("addeditprojectsdiv", function(){
	return {
		restrict: "E",
...
//Directive for adding  projects
applicantObj.directive("addeditdivs", function($compile){
	return function(scope, element, attrs){
		element.bind("click", function(){
			projectcount++;
			console.log("projectcount "+projectcount)
